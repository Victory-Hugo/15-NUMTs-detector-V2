...
#!/bin/bash
#SBATCH -p normal
#SBATCH -J NUMT___IDX__
#SBATCH --time=2000:00:00
#SBATCH -n 1
#SBATCH -o NUMT_out___IDX__.log
#SBATCH -e NUMT_err___IDX__.log
...
BAM_FILES=(
EOF
    # 插入当前脚本编号，避免 heredoc 变量不展开导致的命名问题
    sed -i "s/__IDX__/${i}/g" "$SCRIPT"
    # 把 ASSIGNED 数组写进文件
...
PY
    ...
    REF_GRCh=$BASE_DIR/download/GRCh38_latest_genomic.fna
