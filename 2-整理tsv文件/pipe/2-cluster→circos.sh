...
INPUT_FILE="/mnt/l/20-NUMTs/1-原始结果/data/3-SLE/7-mt_disc_cluster.tsv"
OUTPUT_DIR="/mnt/f/Onedrive/文档（科研）/脚本/Download/15-NUMTs-detector-V2/2-整理tsv文件/output"
OUTPUT_FILE="/mnt/f/Onedrive/文档（科研）/脚本/Download/15-NUMTs-detector-V2/2-整理tsv文件/output/mt.disc.sam.cluster.concat.circos.txt"
FORCE=0
